...
public class ArabianHoroscopoActivity extends AppCompatActivity {

    private Toolbar toolbar;
    private TextView zodiac,t12,t,nextt;
    private RippleView next,back,details;
    private int zodiacPosition;
    private LinearLayout container;
    private AppController controller;
    private CircleImageView zodiacIcon;
    private ArabianHoroscop arabian;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        colors = new ColorDrawable(getResources().getColor(R.color.arabic));
        colors2 = new ColorDrawable(getResources().getColor(R.color.arabic_l));
        if(!Preferences.getInstance(this).isArabo()&&!getIntent().hasExtra("Class")){
            Intent i = new Intent(ArabianHoroscopoActivity.this,InduHoroscopActivity.class);
            ...
            startActivity(i);
        }else if(!Preferences.getInstance(this).isArabo()&&getIntent().hasExtra("Class")){
            Intent i = new Intent(ArabianHoroscopoActivity.this,CelticHoroscopActivity.class);
            i.putExtra("Today",getIntent().getExtras().getString("Today"));
            i.putExtra("Name",getIntent().getExtras().getString("Name"));
            i.putExtra("Age",getIntent().getExtras().getString("Age"));
            i.putExtra("Class",ArabianHoroscopoActivity.this.getClass().getSimpleName());
            startActivity(i);
        }
        setContentView(R.layout.activity_arabian_horoscopo);
        toolbar = (Toolbar) findViewById(R.id.toolbar);
        t = (TextView) findViewById(R.id.oroscopo);
        t.setText(getResources().getString(R.string.di)+" "+getIntent().getExtras().getString("Name"));
        ...
        arabian = new ArabianHoroscop(computeMySign(getIntent().getExtras().getString("Age")),getApplicationContext());
        t12 = (TextView) findViewById(R.id.textView12);
        t12.setText(controller.computeMamoettoB(getIntent().getExtras().getString("Age")));
        zodiacIcon.setImageDrawable(getResources().getDrawable(arabian.getIcon()));


        zodiac.setText(arabian.getDesc());
        ...
        details.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            @Override
            public void onComplete(RippleView rippleView) {
                Intent i = new Intent(ArabianHoroscopoActivity.this,HoroscopActivityDetails.class);
                i.putExtra("Class",ArabianHoroscopoActivity.this.getClass().getSimpleName());
                i.putExtra("Color",new
                        ColorDrawable(getResources().getColor(R.color.arabic)).getColor());
                i.putExtra("Color2",new
                        ColorDrawable(getResources().getColor(R.color.arabic_l)).getColor());
                i.putExtra("Today",getIntent().getExtras().getString("Today"));
                i.putExtra("Name",getIntent().getExtras().getString("Name"));
                i.putExtra("Age",getIntent().getExtras().getString("Age"));
                startActivity(i);
        ...
        change.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new SweetAlertDialog(ArabianHoroscopoActivity.this, SweetAlertDialog.WARNING_TYPE)
                        ...
                        .setCancelClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sDialog) {
                                sDialog.cancel();
                                Intent i = new Intent(ArabianHoroscopoActivity.this,ListPeopleActivity.class);
                                i.putExtra("Class",ArabianHoroscopoActivity.this.getClass().getSimpleName());
                                i.putExtra("Today",getIntent().getExtras().getString("Today"));
                                startActivity(i);
                            }
                        ...
                        .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sweetAlertDialog) {
                                Intent i = new Intent(ArabianHoroscopoActivity.this,MainActivity.class);
                                startActivity(i);
                            }
                        })
                        .show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_about:
                final Intent i = new Intent(ArabianHoroscopoActivity.this,AboutActivity.class);
                i.putExtra("Today",getIntent().getExtras().getString("Today"));
                i.putExtra("Name",getIntent().getExtras().getString("Name"));
                i.putExtra("Age",getIntent().getExtras().getString("Age"));
                startActivity(i);
            ...
            case R.id.menu_other:
                final Intent apps = new Intent(ArabianHoroscopoActivity.this,OtherApps.class);
            ...
            case android.R.id.home:
                Intent back = new Intent(getApplicationContext(), CelticHoroscopActivity.class);
