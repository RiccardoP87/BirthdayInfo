...
public class InduHoroscopActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        colors = new ColorDrawable(getResources().getColor(R.color.indu));
        colors2 = new ColorDrawable(getResources().getColor(R.color.castagnoI));
        if(!Preferences.getInstance(this).isIndu()&&!getIntent().hasExtra("Class")){
            Intent i = new Intent(this,NextBirthdayActivity.class);
            ...
            startActivity(i);
        }else if(!Preferences.getInstance(this).isIndu()&&getIntent().hasExtra("Class")){
            Intent i = new Intent(InduHoroscopActivity.this,ArabianHoroscopoActivity.class);
            i.putExtra("Today",getIntent().getExtras().getString("Today"));
            i.putExtra("Name",getIntent().getExtras().getString("Name"));
            i.putExtra("Age",getIntent().getExtras().getString("Age"));
            i.putExtra("Class",InduHoroscopActivity.this.getClass().getSimpleName());
            startActivity(i);
        }
        controller = new AppController(getApplicationContext());
        setContentView(R.layout.activity_indu_horoscop);
        ...
        t12.setText(controller.getMonth(getIntent().getExtras().getString("Age")));
        indu = new InduHoroscop(computeMySign(getIntent().getExtras().getString("Age")),
                getApplicationContext());

        zodiacIcon.setImageDrawable(getResources().getDrawable(indu.getIcon()));


        zodiac.setText(indu.getDesc());
        ...
        next.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            ...
            public void onComplete(RippleView rippleView) {
                Intent i = new Intent(InduHoroscopActivity.this,NextBirthdayActivity.class);
                i.putExtra("Today",getIntent().getExtras().getString("Today"));
                i.putExtra("Name",getIntent().getExtras().getString("Name"));
                i.putExtra("Age",getIntent().getExtras().getString("Age"));
                startActivity(i);
        ...
        details.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            @Override
            public void onComplete(RippleView rippleView) {
                Intent i = new Intent(InduHoroscopActivity.this,HoroscopActivityDetails.class);
                i.putExtra("Class",InduHoroscopActivity.this.getClass().getSimpleName());
                i.putExtra("Color",new
                        ColorDrawable(getResources().getColor(R.color.indu)).getColor());
                i.putExtra("Color2",new
                        ColorDrawable(getResources().getColor(R.color.castagnoI)).getColor());
                i.putExtra("Today",getIntent().getExtras().getString("Today"));
                i.putExtra("Name",getIntent().getExtras().getString("Name"));
                i.putExtra("Age",getIntent().getExtras().getString("Age"));
                startActivity(i);
        ...
        change.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new SweetAlertDialog(InduHoroscopActivity.this, SweetAlertDialog.WARNING_TYPE)
                        ...
                        .setCancelClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sDialog) {
                                sDialog.cancel();
                                Intent i = new Intent(InduHoroscopActivity.this,ListPeopleActivity.class);
                                i.putExtra("Class",InduHoroscopActivity.this.getClass().getSimpleName());
                                i.putExtra("Today",getIntent().getExtras().getString("Today"));
                                startActivity(i);
                            }
                        ...
                        .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sweetAlertDialog) {
                                Intent i = new Intent(InduHoroscopActivity.this,MainActivity.class);
                                startActivity(i);
                            }
                        })
                        .show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_about:
                final Intent i = new Intent(InduHoroscopActivity.this,AboutActivity.class);
                i.putExtra("Today",getIntent().getExtras().getString("Today"));
                i.putExtra("Name",getIntent().getExtras().getString("Name"));
                i.putExtra("Age",getIntent().getExtras().getString("Age"));
                startActivity(i);
            ...
            case R.id.menu_other:
                final Intent apps = new Intent(InduHoroscopActivity.this,OtherApps.class);
            ...
            case android.R.id.home:
                Intent back = new Intent(getApplicationContext(), ArabianHoroscopoActivity.class);
